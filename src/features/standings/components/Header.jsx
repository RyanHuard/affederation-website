...
const Header = ({ handleSeasonSelect, handleDivisionSelect, seasonId }) => {

  return (

    <div className="bg-white sm:mt-0 sm:pt-12 border-b border-aff-blue">
        <div className="m-auto max-w-7xl px-6">
          <header className="hidden text-3xl font-bold sm:block">
            AFF Standings - {seasonId + 2021}
          </header>
